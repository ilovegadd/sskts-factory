...
var error;
(function (error) {
    class SSKTS extends error_1.SSKTSError {
    }
    error.SSKTS = SSKTS;
    class AlreadyInUse extends alreadyInUse_1.default {
    }
    error.AlreadyInUse = AlreadyInUse;
    class Argument extends argument_1.default {
    }
    error.Argument = Argument;
    class Forbidden extends forbidden_1.default {
    }
    error.Forbidden = Forbidden;
    class ArgumentNull extends argumentNull_1.default {
    }
    error.ArgumentNull = ArgumentNull;
    class NotFound extends notFound_1.default {
    }
    error.NotFound = NotFound;
    class NotImplemented extends notImplemented_1.default {
    }
    error.NotImplemented = NotImplemented;
    class ServiceUnavailable extends serviceUnavailable_1.default {
    }
    error.ServiceUnavailable = ServiceUnavailable;
    class Unauthorized extends unauthorized_1.default {
    }
